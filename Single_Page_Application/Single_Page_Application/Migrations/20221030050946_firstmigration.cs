    ...
    public partial class firstmigration : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_WorkerAreas", x => new { x.WorkerId, x.CustomerId });
                    table.ForeignKey(
                        name: "FK_WorkerAreas_Customers_WorkerId",
                        column: x => x.WorkerId,
                        principalTable: "Customers",
                        principalColumn: "CustomerId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_WorkerAreas_Workers_CustomerId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_WorkerAreas_CustomerId",
                table: "WorkerAreas",
                column: "CustomerId");
